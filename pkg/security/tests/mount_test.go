...
func TestMount(t *testing.T) {
	...
	t.Run("mount", func(t *testing.T) {
		err = test.GetProbeEvent(func() error {
			...
			return assert.Equal(t, "mount", event.GetType(), "wrong event type") &&
	...
	t.Run("mount_resolver", func(t *testing.T) {
		...
		test.WaitSignal(t, func() error {
			...
			return assert.Equal(t, "chmod", event.GetType(), "wrong event type") &&
	...
	t.Run("umount", func(t *testing.T) {
		err = test.GetProbeEvent(func() error {
			...
			return assert.Equal(t, "umount", event.GetType(), "wrong event type") &&
	...
	t.Run("release-mount", func(t *testing.T) {
		test.WaitSignal(t, func() error {
			...
			return assert.Equal(t, "chown", event.GetType(), "wrong event type") &&
