...
//
// The constructor functions associated with this type use the default foundry.
type Tags struct {
...
// ReadOnlySlice returns the slice of strings contained in this tagset.  As the
// name suggests, the returned slice must not be modified, including being used
// as the first argument to `append`.  This function should only be used to interface
// with external APIs that do not accept the Tags type.
func (tags *Tags) ReadOnlySlice() []string {
	return tags.tags
}
